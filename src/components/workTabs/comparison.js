...
class Comparison extends Component {
    ...
    render() {
        switch (this.props.selected) {
            case 'Roofing':
                return (
                    <div className="comparisonContainer">
                        <p className="comparisonInfo"> Much like the skin, your roofing system is meant to protect the home's
                            interior from harsh external elements. Healthy skin relies on three layers, each serving a unique purpose to ensure
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>Shingles, Drip Edge, Ice & Water Shield</td>
                            </tr>
                            <tr>
                                <td>Dermis</td>
                                <td>Middle layer allowing the system to "sweat-out" trapped moisture</td>
                                <td>Breathable synthetic underlayment & Ridge/Soffit Vents</td>
                            </tr>
                            <tr>
                                <td>Hypodermis</td>
                                <td>Innermost layer providing stability and insulation</td>
                                <td>Solid deck sheathing & attic fiberglass insulation</td>
                            </tr>
                        </table>
                    </div>
            ...
            case 'Gutters':
                return (
                    <p className="comparisonInfo"> The body uses lymph vessels (similar to blood vessels) to drain potentially infectious agents away
            ...
            case 'Doors & Windows':
                return (
                    <p className="comparisonInfo"> The respiratory system is responsible for regulating the air flow and quality that enters and exits the body.
            ...
            case 'Siding':
                return (
                    <div className="comparisonContainer">
                        <p className="comparisonInfo"> Your siding system, just as your roofing system, is similar to the exocrine (skin) system. An effective siding system requires three main layers which provide a weather-resistant, ventilated exterior
