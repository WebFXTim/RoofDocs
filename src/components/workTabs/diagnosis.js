...
// Styling
import '../../style/components/workTabs/diagnosis.css';
...
class Diagnosis extends Component {
    ...
    render() {
        switch (this.props.selected) {
            case 'Roofing':
                return (
                    <p className="diagnosisInfo"> Our Roof Docs are trained how to properly diagnose potential issues with your
            ...
            case 'Gutters':
                return (
                    <p className="diagnosisInfo"> Your gutter system faces a number of potential ailments including clogging, being improperly
            ...
            case 'Doors & Windows':
                return (
                    ...
                    <p className="diagnosisInfo"> Whether it's seal failure, draftiness, or cracked/warped framing, our Roof Docs are able to detect
            ...
            case 'Siding':
                return (
                    <p className="diagnosisInfo"> Our Roof Docs are able to perform check-ups on all forms of siding including vinyl, wood,
